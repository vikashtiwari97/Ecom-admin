...
const UpdateGoldenBangles = ({ productSlug, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(`/api/golden-bangles/get/${productSlug}`, {
                    headers: {
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            const response = await axios.put(`/api/golden-bangles/update/${productSlug}`, formData, {
                headers: {
        ...
        <div className="container-fluid">
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Update Collections</h6>
                </div>
...
export default UpdateGoldenBangles;
