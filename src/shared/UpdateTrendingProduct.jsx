...
const UpdateTrendingProduct = ({ productSlug, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(`/api/trending-products/${productSlug}`, {
                    headers: {
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            const response = await axios.put(`/api/trending-products/update/${productSlug}`, formData, {
                headers: {
        ...
        <div className="container-fluid">
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Update Trending Product</h6>
                </div>
