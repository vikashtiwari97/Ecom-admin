...
const UpdateCollections = ({ productSlug, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(`/api/collections/get/${productSlug}`, {
                    headers: {
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            const response = await axios.put(`/api/collections/update/${productSlug}`, formData, {
                headers: {
