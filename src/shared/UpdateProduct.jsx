...
// const UpdateProduct = ({ productSlug, onClose }) => {
...
//         try {
//             const response = await axios.put(`/api/products/${productSlug}`, formData, {
//                 headers: {
...
//                 setInStock(updatedProduct.color || '');
//                 setInStock(updatedProduct.rating || '');
