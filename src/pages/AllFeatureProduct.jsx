...
// import UpdateFeatureProduct from '../shared/UpdateFeatureProduct';

// const AllFeatureProduct = () => {
...
//         const deleteUrl = `/api/featured-products/delete/${slug}`;
...
const AllFeatureProduct = () => {
    ...
    const confirmDelete = () => {
        ...
        const deleteUrl = `/api/featured-products/delete/${productToDelete}`;
