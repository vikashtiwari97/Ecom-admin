...
import UpdateSlideImage from '../shared/UpdateSlideImage';
...
const AllSlideImage = () => {
    ...
    const confirmDelete = () => {
        ...
        const deleteUrl = `/api/slide-images/delete/${productToDelete}`;
        ...
        <div className="container-fluid">
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">All Silver Products</h6>
                </div>
            ...
            {isEditModalOpen && productToEdit && (
                <div className="modal-overlay" onClick={closeEditModal}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <UpdateSlideImage 
                            productSlug={productToEdit.slug} // Pass the productSlug to UpdateSlideImage
