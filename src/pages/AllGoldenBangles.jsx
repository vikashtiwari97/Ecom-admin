...
import UpdateGoldenBangles from '../shared/UpdateGoldenBangles';
import DeleteConfirmation from './DeleteConfirmation'; // Import the new delete confirmation component

const AllGoldenBangles = () => {
    ...
    const [productToDelete, setProductToDelete] = useState(null); // New state for selected product to delete
    ...
    const fetchProducts = () => {
        ...
        axios.get('/api/golden-bangles/get', {
            headers: {
    ...
    const handleConfirmDelete = () => {
        ...
        const deleteUrl = `/api/golden-bangles/delete/${productToDelete}`;
        ...
        <div className="container-fluid">
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">All Golden Product</h6>
                </div>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='text-center'>
                                                <button 
                                                    ...
                                                    onClick={() => handleDeleteClick(row.slug)} // Open delete modal
                                                >
            ...
            {isEditModalOpen && productToEdit && (
                <div className="modal-overlay" onClick={closeEditModal}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <UpdateGoldenBangles 
                            productSlug={productToEdit.slug} // Pass the productSlug to UpdateGoldenBangles
...
export default AllGoldenBangles;
