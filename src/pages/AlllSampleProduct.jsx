...
import UpdateSampleProduct from '../shared/UpdateSampleProduct';
import DeleteConfirmation from './DeleteConfirmation'; // Import the new DeleteConfirmation component

const AllSampleProduct = () => {
    ...
    const confirmDelete = () => {
        ...
        const deleteUrl = `/api/sample-products/delete/${productToDelete}`;
        ...
        <div className="container-fluid">
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">All Sample Product</h6>
                </div>
...
export default AllSampleProduct;
